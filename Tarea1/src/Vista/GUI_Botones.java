...
public class GUI_Botones extends javax.swing.JPanel {
    Control_FRM_MantenimientoEstudiante controlE;
    Control_FRM_MantenimientoCursos controlC;

    /**
     * Creates new form GUI_RegistroEstudiantes
     */
    public GUI_Botones() {
        initComponents();
    }
    public void agregarEventos(Control_FRM_MantenimientoEstudiante control)
        {
            this.controlE=control;
            this.btn_Consultar.addActionListener(control);
    ...
    public void agregarEventos(Control_FRM_MantenimientoCursos control)
        {
            this.controlC=control;
            this.btn_Consultar.addActionListener(control);
            this.btn_Agregar.addActionListener(control);
            this.btn_Modificar.addActionListener(control);
            this.btn_Eliminar.addActionListener(control);
